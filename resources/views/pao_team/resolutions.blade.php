@extends('layouts.app')
@section('title', 'Programming IA Resolutions')

@section('sidebar')
    <a href="{{ route('pao.dashboard') }}">Dashboard</a>
    <a href="{{ route('pao.downloadables') }}">Downloadables</a>
    <a href="{{ route('pao.resolutions') }}" style="background:rgba(255,255,255,0.1); border-left-color:white;">IA
        Resolutions</a>
@endsection
