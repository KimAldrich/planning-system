@extends('layouts.app')
@section('title', 'Contract Management Downloadables')
...
@section('content')
            ...
            @forelse($files as $file)
                ...
                <div class="ui-card">
                    ...
                    <div style="display: flex; gap: 8px; margin-bottom: 15px;">
                        ...
                        @if (auth()->user()->role == 'cm_team' || auth()->user()->role == 'admin')
                            <form action="{{ route('cm.downloadables.delete', $file->id) }}" method="POST" style="margin: 0;" data-async-target="#downloadablesList" data-async-confirm="Delete this file?" data-async-success="silent">
                                @csrf
                                @method('DELETE')
    ...
    <div id="upload-form" class="tab-pane">
        <form action="{{ route('cm.downloadables.upload') }}" method="POST" enctype="multipart/form-data" data-async-target="#downloadablesList" data-async-reset="true">
            @csrf
