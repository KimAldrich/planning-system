@extends('layouts.app')
@section('title', 'Right Of Way Downloadables')
...
@section('content')
                ...
                <div class="ui-card">
                    ...
                    <div style="display: flex; gap: 8px; margin-bottom: 15px;">
                        ...
                        @if (auth()->user()->role == 'row_team' || auth()->user()->role == 'admin')
                            <form action="{{ route('row.downloadables.delete', $file->id) }}" method="POST" style="margin: 0;" data-async-target="#downloadablesList" data-async-confirm="Delete this file?" data-async-success="silent">
                                @csrf
                                @method('DELETE')
    ...
    <div id="upload-form" class="tab-pane">
        <form action="{{ route('row.downloadables.upload') }}" method="POST" enctype="multipart/form-data" data-async-target="#downloadablesList" data-async-reset="true">
            @csrf
