@extends('layouts.app')
@section('title', 'Program Completion Downloadables')
...
@section('content')
    ...
    <div id="upload-form" class="tab-pane">
        <form action="{{ route('pcr.downloadables.upload') }}" method="POST" enctype="multipart/form-data" data-async-target="#downloadablesList" data-async-reset="true">
            @csrf
