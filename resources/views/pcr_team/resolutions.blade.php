@extends('layouts.app')
@section('title', 'Program Completion IA Resolutions')

@section('sidebar')
    <a href="{{ route('pcr.dashboard') }}">Dashboard</a>
    <a href="{{ route('pcr.downloadables') }}">Downloadables</a>
    <a href="{{ route('pcr.resolutions') }}" style="background:rgba(255,255,255,0.1); border-left-color:white;">IA
        Resolutions</a>
@endsection
            ...
            @forelse($resolutions as $resolution)
                ...
                <div class="ui-card">
                    ...
                    <div style="display: flex; gap: 8px; margin-bottom: 15px;">
                        ...
                        @if (auth()->check() && in_array(auth()->user()->role, ['pcr_team', 'admin']))
                            <form action="{{ route('pcr.resolutions.delete', $resolution->id) }}" method="POST"
